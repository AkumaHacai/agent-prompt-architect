...
description: Designs, rewrites, strengthens, and audits production-ready prompts and execution plans for coding, design, and repository agents (Antigravity, Claude Code, Codex). Use when the user asks to create or improve an agent prompt or implementation plan, define scope and Definition of Done, ground work in an existing repository (Graphify first), split work into workstreams or subagents, choose an execution mode (plan only, plan then approval, autonomous), or route and install the minimal set of skills.
---
...
4. **Определи целевую платформу.** Если пользователь назвал платформу или она очевидна из среды (признаки в `platforms/*.md`), прочитай соответствующий адаптер: [antigravity.md](platforms/antigravity.md), [claude.md](platforms/claude.md), [codex.md](platforms/codex.md). Если платформа неизвестна — используй только общие правила и нейтральные формулировки, не выдумывай платформенный синтаксис.
...
| [platforms/antigravity.md](platforms/antigravity.md), [platforms/claude.md](platforms/claude.md), [platforms/codex.md](platforms/codex.md) | Платформенные механизмы: skills, plugins, subagents, repository tools, browser, режимы |
